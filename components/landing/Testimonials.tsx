        ...
        >
          {testimonials.map((t) => (
            <motion.article
              ...
              className="bg-[#F8FAFC] rounded-2xl p-6 shadow-[0_2px_16px_rgba(0,0,0,0.07)] border border-[#E2E8F0] flex flex-col"
            >
              {/* Stars */}
              ...
              {/* Quote icon */}
              <Quote
                className="w-6 h-6 text-[#DBEAFE] fill-[#DBEAFE] mb-3"
                aria-hidden="true"
              />

              {/* Quote text */}
              <blockquote className="text-sm text-[#1E293B] leading-relaxed flex-1 mb-6">
                &ldquo;{t.quote}&rdquo;
              </blockquote>
              ...
              <footer className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 ${
                    t.avatarColor === "blue" ? "bg-[#2563EB]" : "bg-[#14B8A6]"
                  }`}
                  aria-hidden="true"
                >
                  {t.initials}
